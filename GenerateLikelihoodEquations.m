...
%is less than or greater than Tcrit. Note taking weak equality here
%relies on the piecewise continuity referred to in the writeup. Due to
%continuity at the breakpoint we can use either definition
...
%substitute into the likelihood derivative for T, note transposition to
%ensure orientations are row-wise
